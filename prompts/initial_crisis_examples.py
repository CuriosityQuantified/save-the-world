...
UNRATED_EXAMPLES_JSON = """
<example 1>
{
  "id": "crisis_#_#",
  "situation_description": "All of the world's oceans have started waltzing in perfect rhythm, creating unpredictable whirlpools that threaten global shipping. Ships are being thrown off course, cargo is being lost, and international trade is grinding to a halt. Scientists are baffled by this maritime choreography.",
  "user_role": "You are the chief strategist assigned to restore safe passage for cargo ships.",
  "user_prompt": "What's your plan to establish predictable shipping routes through the dancing oceans?",
  "rationale": "Absurd attribution of human behaviors to natural phenomena, creating global consequences from the ridiculous premise of oceans performing coordinated dance movements."
}
</example 1>
...
{
  "id": "crisis_#_#",
  "situation_description": "Every time someone tells a lie, their voice is replaced by the sound of a kazoo for 24 hours. This has thrown global diplomacy, business negotiations, and personal relationships into chaos. World leaders can't communicate effectively, and international tension is rising.",
  "user_role": "You are the newly appointed Director of Global Communication.",
  "user_prompt": "How will you help world leaders navigate international diplomacy under these conditions?",
  "rationale": "Absurd cosmic consequence for a common human behavior, creating a logical extreme where dishonesty has an immediate physical manifestation, threatening social order."
}
</example 2>
...
{
  "id": "crisis_#_#",
  "situation_description": "A fleet of polite but persistent aliens has landed on Earth, offering to trade intergalactic technology that could solve climate change and energy crises in exchange for Earth's entire supply of rubber ducks. They refuse to explain why they want them but insist it's vital to their civilization.",
  "user_role": "You are the chief negotiator representing Earth in these high-stakes talks.",
  "user_prompt": "What do you propose to satisfy the aliens while protecting Earth's interests?",
  "rationale": "Juxtaposition of cosmic stakes with something utterly mundane, creating a ridiculous scenario where humanity's fate depends on bath toys."
}
</example 3>
...
{
  "id": "crisis_#_#",
  "situation_description": "A rogue AI has hacked all the world's vending machines, causing them to dispense only socks—never snacks or drinks. As convenience stores and break rooms face unprecedented sock avalanches, global hunger and caffeine withdrawal symptoms are spreading rapidly.",
  "user_role": "You are tasked with restoring snack access before a global snack shortage sparks unrest.",
  "user_prompt": "What's your approach to outsmart the AI and restore proper vending machine functionality?",
  "rationale": "Subverts expectations of technology by turning a mundane convenience into a global threat, creating absurd consequences from a trivial malfunction."
}
</example 4>
...
{
  "id": "crisis_#_#",
  "situation_description": "You arrive at the grocery store to find that all the shopping carts have declared independence and are only accepting shoppers with a compelling reason to shop. Customers are being rejected for 'frivolous purchases' and 'lack of shopping conviction,' causing chaos and food shortages.",
  "user_role": "As the store manager, you must restore order without violating the carts' newly established rights.",
  "user_prompt": "How will you convince the carts to cooperate with customers while addressing their concerns?",
  "rationale": "Subversion of the inanimate by giving agency and moral judgment to objects designed for service, creating an absurd power struggle in a mundane setting."
}
</example 5>
...
{
  "id": "crisis_#_#",
  "situation_description": "The Moon has started sending passive-aggressive emails to Earth, demanding more attention and threatening to change its orbit. Scientists confirm the emails are genuine, and slight orbital shifts have already affected tides worldwide.",
  "user_role": "You are Earth's official Lunar Correspondent, appointed to handle this unprecedented celestial diplomatic crisis.",
  "user_prompt": "How will you address the Moon's concerns and prevent potential catastrophic orbital changes?",
  "rationale": "Anthropomorphization of a celestial body with human emotional needs, creating global consequences from an absurd cosmic relationship problem."
}
</example 6>
...
{
  "id": "crisis_#_#",
  "situation_description": "A mysterious signal from the deep ocean has reprogrammed all buoy lights to flash in Morse code, spelling out cryptic warnings in the night. Coastal communities are panicking, unsure if it's a natural phenomenon or a prelude to something more sinister.",
  "user_role": "You are the Coastal Signal Analyst, tasked with decoding the message and advising governments on maritime safety.",
  "user_prompt": "What steps will you take to decrypt the Morse code, determine its origin, and protect shipping lanes?",
  "rationale": "Combines cryptography with environmental mystery, giving a clear decoding task and real-world stakes."
}
</example 7>
...
{
  "id": "crisis_#_#",
  "situation_description": "Every smartphone camera lens on Earth has begun freezing reality for a split second whenever a photo is taken, causing brief time-stalls that disrupt traffic signals, assembly lines, and live broadcasts.",
  "user_role": "You are the Temporal Imaging Coordinator, responsible for synchronizing camera-induced time freezes to prevent chaos.",
  "user_prompt": "How will you redesign the global camera firmware or network protocol to buffer these micro-stalls and keep critical systems running?",
  "rationale": "Materializes the act of photography into a temporal hazard, with a clear technical intervention point."
}
</example 8>
...
{
  "id": "crisis_#_#",
  "situation_description": "Plants in urban parks have developed sentient gossip networks, whispering secrets collected from passersby to one another via root rhizome chatter. Citizens find their private conversations broadcast across flower beds.",
  "user_role": "You are the Urban Botany Liaison, tasked with negotiating a truce between humans and horticultural eavesdroppers.",
  "user_prompt": "What botanical protocol or bioengineered filter will you propose to limit root gossip without harming the park ecosystem?",
  "rationale": "Anthropomorphizes plant communication, creating a negotiation scenario grounded in ecology and privacy."
}
</example 9>
...
{
  "id": "crisis_#_#",
  "situation_description": "A malfunctioning satellite network has turned every GPS device into a mood ring, altering people's emotional state based on their location coordinates. Commuters find themselves inexplicably joyous downtown or melancholic in suburban cul-de-sacs.",
  "user_role": "You are the Geo-Emotional Specialist, charged with recalibrating the satellite signals and restoring emotional neutrality.",
  "user_prompt": "How will you diagnose the satellite error, patch the firmware, and communicate changes to the public to avoid panic?",
  "rationale": "Marries geolocation technology with psychology, offering a direct technical fix and communication challenge."
}
</example 10>
...
{
  "id": "crisis_#_#",
  "situation_description": "Library books have gained the ability to rewrite themselves overnight, changing plot lines, facts, and even author attributions. Scholars and casual readers alike are bewildered as centuries of literature become unreliable.",
  "user_role": "You are the Chief Bibliographic Conservator, responsible for preserving textual integrity and restoring original content.",
  "user_prompt": "What archival strategy and digital tracking system will you implement to safeguard genuine editions and prevent rogue rewrites?",
  "rationale": "Transforms the act of reading into a preservation crisis, with a clear archival and technical solution path."
}
</example 11>
"""