...
{{
  ...
  "situation_description": "[3-4 sentences describing the NEXT stage of the crisis, reacting to Turn PREVIOUS_TURN's events and user response] The autopilot counters smaller waves effectively, but the software overheats under heavy load and the turbines draw too much power—leaving several ships dead in the water and creating an energy crisis among the fleet.",
  "user_role": "[1 sentence establishing the user's role or position in addressing this next stage of the crisis]",
  "user_prompt": "[1 clear question asking for the user's specific plan or approach to this new development]"
}},
{{
  "id": "crisis_X_followup_3",
  ...
  "situation_description": "[3-4 sentences describing the NEXT stage of the crisis, reacting to Turn PREVIOUS_TURN's events and user response] The stabilizer platforms reduce wave height as intended, but one platform fails when an unexpected deep‐sea current drags its anchor loose. Shipping lanes near that chokepoint remain perilous, forcing a rapid recovery mission.",
  "user_role": "[1 sentence establishing the user's role or position in addressing this next stage of the crisis]",
  "user_prompt": "[1 clear question asking for the user's specific plan or approach to this new development]"
}},
{{
  "id": "crisis_X_followup_4",
  ...
  "situation_description": "[3-4 sentences describing the NEXT stage of the crisis, reacting to Turn PREVIOUS_TURN's events and user response] The resonance cancelers stabilize about 80% of the rhythmic waves, and the predictive model correctly forecasts three calm windows. However, a power cable to one canceler is severed by a trawler, forcing an emergency repair just as a major freighter prepares to depart.",
  "user_role": "[1 sentence establishing the user's role or position in addressing this next stage of the crisis]",
  "user_prompt": "[1 clear question asking for the user's specific plan or approach to this new development]"
}},
{{
  "id": "crisis_X_followup_5",
